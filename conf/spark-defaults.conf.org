...
spark.sql.catalog.__SPARK_CATALOG_NAME__.uri               jdbc:postgresql://__DOMAIN_NAME__:5432/__SPARK_DB_NAME__
spark.sql.catalog.__SPARK_CATALOG_NAME__.jdbc.useSSL       true
spark.sql.catalog.__SPARK_CATALOG_NAME__.jdbc.user         __SPARK_DB_USERNAME__
...
spark.sql.catalog.__SPARK_CATALOG_NAME__.s3.endpoint       https://__DOMAIN_NAME__:9000/__SPARK_ENDPOINT_NAME__/
